            ...
            .withNewSpec()
               ...
               .withNewTemplate()
                   ...
                   .withNewSpec()
                      ...
                      .withVolumes(List.of(
                          new VolumeBuilder().withName(windupResource.getSpec().getApplication_name() + "-postgresql-pvol").build()))
                      .addNewContainer()
                        .withName(windupResource.getSpec().getApplication_name() + "-postgresql")
                        ...
                        .endResources()
                        .withVolumeMounts(List.of(
                              new VolumeMountBuilder().withName(windupResource.getSpec().getApplication_name() + "-postgresql-pvol").withMountPath("/var/lib/pgsql/data").withReadOnly(false).build()
                              ))
